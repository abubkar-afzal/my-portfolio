...
const DesignSkills = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 mm:grid-cols-2 lm:grid-cols-2 t:grid-cols-3 l:grid-cols-4 gap-4 sm:gap-4 mm:gap-5 lm:gap-5 t:gap-6 l:gap-6 ll:gap-8 k:gap-10 my:gap-12 justify-items-center l:justify-items-start px-2 sm:px-2 t:px-4 l:pl-[4rem]">
