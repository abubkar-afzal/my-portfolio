          ...
          <div className="flex ">
            ...
            <div className="w-[90%]">
              ...
              <div className="my-[1.5rem] font-thin">
                I got 912 marks in lahore board out of 1200.
              </div>
            </div>
          </div>
          <div className="flex ">
            ...
            <div className="w-[90%]">
              ...
              <div className="my-[1.5rem] font-thin">
                I got 855 marks in Lahore Borad out of 1100.
              </div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div className="flex ">
            ...
            <div className="w-[90%]">
              ...
              <div className="my-[1.5rem] font-thin">
                In Heaven Of Education School System which is located on Amir Road Lahore.
              </div>
            </div>
          </div>
          <div className="flex ">
            ...
            <div className="w-[90%]">
              ...
              <div className="my-[1.5rem] font-thin">
                On Shope # 8, Haq Computer, Irfan Center Hall Road Lahore.
              </div>
            </div>
          </div>
        </div>
