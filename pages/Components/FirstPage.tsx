...
const FirstPage = () => {
  return (
    <div id="home" className="min-h-screen flex items-center justify-center overflow-hidden relative px-4 sm:px-6 mm:px-6 lm:px-8 t:px-10 l:px-12 ll:px-16 k:px-20 my:px-24  sm:pt-12 l:pt-0">
